-- [nfnl] Compiled from nvim/fnl/nap.fnl by https://github.com/Olical/nfnl, do not edit.
...
safe_qf_cnewer = _6_
local operators = {m = {prev = {rhs = "<Plug>(Marks-prev)", opts = {desc = "prev mark"}}, next = {rhs = "<Plug>(Marks-next)", opts = {desc = "next mark"}}}, b = {prev = {rhs = cmd("bprevious"), opts = {desc = "prev buffer"}}, next = {rhs = cmd("bnext"), opts = {desc = "next buffer"}}}, B = {prev = {rhs = "<Plug>(buf-surf-back)", opts = {desc = "prev buffer (history)"}}, next = {rhs = "<Plug>(buf-surf-forward)", opts = {desc = "next buffer (history)"}}}, r = {prev = {rhs = lua_cmd("require('harpoon.ui').nav_prev()"), opts = {desc = "prev registered buffer"}}, next = {rhs = lua_cmd("require('harpoon.ui').nav_next()"), opts = {desc = "next registered buffer"}}}, e = {prev = {rhs = "g,", opts = {desc = "prev edit"}}, next = {rhs = "g;", opts = {desc = "next edit"}}}, d = {prev = {rhs = vim.diagnostic.goto_prev(diagnostic_wrn_options), opts = {desc = "prev diagnostic warning"}}, next = {rhs = vim.diagnostic.goto_next(diagnostic_wrn_options), opts = {desc = "next diagnostic warning"}}, mode = {"n", "v", "o"}}, D = {prev = {rhs = vim.diagnostic.goto_prev(diagnostic_err_options), opts = {desc = "prev diagnostic error"}}, next = {rhs = vim.diagnostic.goto_next(diagnostic_err_options), opts = {desc = "next diagnostic error"}}, mode = {"n", "v", "o"}}, q = {prev = {rhs = cmd("Qprev"), opts = {desc = "prev quickfix"}}, next = {rhs = cmd("Qnext"), opts = {desc = "next quickfix"}}}, Q = {prev = {rhs = cmd("qfirst"), opts = {desc = "first quickfix"}}, next = {rhs = cmd("qlast"), opts = {desc = "last quickfix"}}}, ["<C-q>"] = {prev = {rhs = cmd("cpfile"), opts = {desc = "prev quickfix file"}}, next = {rhs = cmd("cnfile"), opts = {desc = "next quickfix file"}}}, ["<M-q>"] = {prev = {rhs = safe_qf_colder, opts = {desc = "prev quickfix list"}}, next = {rhs = safe_qf_cnewer, opts = {desc = "next quickfix list"}}}, l = {prev = {rhs = cmd("Lprev"), opts = {desc = "prev location"}}, next = {rhs = cmd("Lnext"), opts = {desc = "next location"}}}, L = {prev = {rhs = cmd("lfirst"), opts = {desc = "first location"}}, next = {rhs = cmd("llast"), opts = {desc = "last location"}}}, ["<C-l>"] = {prev = {rhs = cmd("lpfile"), opts = {desc = "prev location file"}}, next = {rhs = cmd("lnfile"), opts = {desc = "next location file"}}}, ["<M-l>"] = {prev = {rhs = cmd("lolder"), opts = {desc = "prev location list"}}, next = {rhs = cmd("lnewer"), opts = {desc = "next location list"}}}}
return nap.setup({next_prefix = "]", prev_prefix = "[", next_repeat = "<c-n>", prev_repeat = "<c-p>", operators = operators})
