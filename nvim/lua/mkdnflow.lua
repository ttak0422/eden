...
local modules = {conceal = true, cursor = true, links = true, lists = true, maps = true, paths = true, tables = true, cmp = false, folds = false, bib = false, buffers = false, yaml = false}
local filetypes = {md = true, rmd = true, markdown = true}
local bib = {default_path = nil, find_in_root = true}
local perspective = {priority = "first", fallback = "current", update = false, root_tell = false, nvim_wd_heel = false}
local links
...
local tables = {trim_whitespace = true, format_on_move = true, auto_extend_rows = false, auto_extend_cols = false}
local mappings = {MkdnEnter = {{"n", "v"}, "<CR>"}, MkdnNextHeading = {"n", "]]"}, MkdnPrevHeading = {"n", "[["}, MkdnIncreaseHeading = {"n", "+"}, MkdnDecreaseHeading = {"n", "-"}, MkdnToggleToDo = {{"n", "v"}, "<C-Space>"}, MkdnNewListItemBelowInsert = {"n", "o"}, MkdnNewListItemAboveInsert = {"n", "O"}, MkdnUpdateNumbering = {"n", "<localleader>nn"}, MkdnTableNextCell = {"i", "<Tab>"}, MkdnTablePrevCell = {"i", "<S-Tab>"}, MkdnTableNextRow = {"i", "<S-M-CR>"}, MkdnTablePrevRow = {"i", "<M-CR>"}, MkdnTableNewRowBelow = {"n", "<localleader>ir"}, MkdnTableNewRowAbove = {"n", "<localleader>iR"}, MkdnTableNewColAfter = {"n", "<localleader>ic"}, MkdnTableNewColBefore = {"n", "<localleader>iC"}, MkdnUnfoldSection = false, MkdnFoldSection = false, MkdnExtendList = false, MkdnNewListItem = false, MkdnYankFileAnchorLink = false, MkdnYankAnchorLink = false, MkdnTagSpan = false, MkdnDestroyLink = false, MkdnCreateLinkFromClipboard = false, MkdnCreateLink = false, MkdnFollowLink = false, MkdnPrevLink = false, MkdnNextLink = false, MkdnMoveSource = false, MkdnGoForward = false, MkdnGoBack = false, MkdnSTab = false, MkdnTab = false}
