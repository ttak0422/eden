...
sources = {null.builtins.diagnostics.eslint.with({prefer_local = "node_modules/.bin", condition = _1_}), null.builtins.formatting.tidy, null.builtins.formatting.fixjson, null.builtins.formatting.taplo, null.builtins.formatting.shfmt, null.builtins.formatting.stylua, null.builtins.formatting.yapf, null.builtins.formatting.google_java_format, null.builtins.formatting.nixfmt, null.builtins.formatting.dart_format, null.builtins.formatting.gofmt, null.builtins.formatting.rustfmt, null.builtins.formatting.yamlfmt, null.builtins.formatting.prettier.with({prefer_local = "node_modules/.bin", runtime_condition = _2_}), null.builtins.formatting.deno_fmt.with({runtime_condition = _3_}), dhall_format, fnlfmt}
